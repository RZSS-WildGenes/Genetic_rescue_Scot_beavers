# KaraDicks
# This script uses the function `basic.stats` in hierfstat to gernerate summary stats for each population from the SNP files. It takes a hierfstat input file and calculates the following basic populations statistics: Hobs, Hs and Fis. It then summarises these per population, providing means and confidence intervals. 
